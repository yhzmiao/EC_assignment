...
def multi_play(e, fitness_list, gain_list, time_list, ind):
...
def calc_fitness(individual):
    ...
    new_fit = 11 * defeat + (800 + gain) / 160 + 1 / tot_time
    #print(gain_list)
    if (ret < 0):
        ret = min(2, 10 / (-ret))
    print(ret, var, std, gain, new_fit)
    return (ret, var, std, gain, new_fit)
